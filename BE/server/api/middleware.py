...
EXCLUDED_PREFIXES = ['/api/user/login/', '/api/user/signup/', '/api/user/validate-jwt/', '/api/user/csrftoken/', '/admin/', '/api/user/csrftoken/', '/api/user/validate-jwt/', '/api/user/signup/', '/chat/']
